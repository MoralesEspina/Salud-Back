...
-- Schema sissaludv3
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `sissaludv3` DEFAULT CHARACTER SET utf8 ;
USE `sissaludv3` ;

-- -----------------------------------------------------
-- Table `sissaludv3`.`job`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sissaludv3`.`job` (
...
-- -----------------------------------------------------
-- Table `sissaludv3`.`person`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sissaludv3`.`person` (
  `uuid` VARCHAR(36) NOT NULL,
  ...
  CONSTRAINT `fk_person_job1`
    ...
    REFERENCES `sissaludv3`.`job` (`uuid`),
...
-- -----------------------------------------------------
-- Table `sissaludv3`.`rol`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sissaludv3`.`rol` (
...
-- -----------------------------------------------------
-- Table `sissaludv3`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sissaludv3`.`user` (
  `uuid` VARCHAR(36) NOT NULL,
...
-- -----------------------------------------------------
-- Table `sissaludv3`.`autorization`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sissaludv3`.`autorization` (
  `uuid` VARCHAR(36) NOT NULL,
  ...
  CONSTRAINT `autorization_person`
    ...
    REFERENCES `sissaludv3`.`person` (`uuid`),
  CONSTRAINT `autorization_user`
    FOREIGN KEY (`user_uuid`)
    REFERENCES `sissaludv3`.`user` (`uuid`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `sissaludv3`.`vacationrequest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sissaludv3`.`vacationrequest` (
  `uuid` VARCHAR(36) NOT NULL,
  `register` VARCHAR(45) NULL DEFAULT NULL,
  `submittedAt` DATE NULL DEFAULT NULL,
  `modifiedAt` DATE NULL DEFAULT NULL,
  `lastVacationFrom` DATE NULL DEFAULT NULL,
  `lastVacationTo` DATE NULL,
